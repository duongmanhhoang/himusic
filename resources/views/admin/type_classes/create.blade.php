                ...
                <div class="col-md-8 mx-auto">
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <form class="m-form m-form--fit m-form--label-align-right" method="post"
                              action="{{route('admin.type_classes.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" name="name" class="form-control m-input" value="{{old('name')}}">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea name="description" class="form-control m-input" rows="10">{{ old('description') }}</textarea>
