                ...
                <form class="m-form m-form--fit m-form--label-align-right" method="post"
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" name="title" class="form-control m-input" value="{{old('title', $video->title)}}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" name="video_id" class="form-control m-input" value="{{old('video_id', $video->video_id)}}" >
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <textarea name="description" class="form-control m-input" rows="8">{{old('description' , $video->description)}}</textarea>
                            @if($errors->has('title'))
                                <p class="text-danger">{{$errors->first('title')}}</p>
                            @endif
                        </div>
