                        ...
                        <form class="m-form m-form--fit m-form--label-align-right" method="post"
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" class="form-control m-input" id="title" title="title"
                                           name="title"
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <select class="form-control m-input m-select2" id="m_select2_1" name="cate_id">
                                        ...
                                        @foreach($categories as $category)
                                            <option @if($category->id == $post->cate_id){{'selected'}}@endif value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
                                    </select>
