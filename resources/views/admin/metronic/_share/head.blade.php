<head>
    ...
    <link href="{{asset('admin/metronic/vendors/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />
    ...
    <!--end::Page Vendors -->
    <link href="{{asset('admin/metronic/vendors/base/vendors.bundle.css')}}" rel="stylesheet" type="text/css" />

    {{--<!--RTL version:<link href="{{asset('admin/metronic/vendors/base/vendors.bundle.rtl.css" rel="stylesheet')}}" type="text/css" />-->--}}
    <link href="{{asset('admin/metronic/demo/default/base/style.bundle.css')}}" rel="stylesheet" type="text/css" />

    {{--<!--RTL version:<link href="{{asset('admin/metronic/demo/default/base/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />-->--}}

    <!--end::Base Styles -->
    <link rel="shortcut icon" type="image/png" href="{{asset('barcino/images/favicon.png')}}"/>
    <link rel="shortcut icon" type="image/png" href="{{asset('barcino/images/favicon.png')}}"/>
