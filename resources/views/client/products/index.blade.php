                        ...
                        <form class="">
                            <div class="form-group col-md-4 pull-right">
                                <select class="form-control" name="order" onchange="this.form.submit()">
                                    <option value="name_desc" @if(isset($_GET['order']) && $_GET['order'] == 'name_desc'){{'selected'}}@endif>
                                        Mới nhất
                                    </option>
                                    <option value="name_asc" @if(isset($_GET['order']) && $_GET['order'] == 'name_asc'){{'selected'}}@endif>
                                        Cũ nhất
                                    </option>
                                    <option value="price_asc" @if(isset($_GET['order']) && $_GET['order'] == 'price_asc'){{'selected'}}@endif>
                                        Theo giá: Từ thấp tới cao
                                    </option>
                                    <option value="price_desc" @if(isset($_GET['order']) && $_GET['order'] == 'price_desc'){{'selected'}}@endif>
